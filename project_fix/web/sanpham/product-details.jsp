...
<<<<<<< HEAD
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img src="../GUI/imgsanpham/1.png" class="d-block w-100" alt="Sunset Over the City"/>
                        
                    </div>

                    <!-- Single item -->
                    <div class="carousel-item">
                        <img src="../GUI/imgsanpham/4.png" class="d-block w-100" alt="Canyon at Nigh"/>
                        
                    </div>

                    <!-- Single item -->
                    <div class="carousel-item">
                        <img src="../GUI/imgsanpham/3.png" class="d-block w-100" alt="Cliff Above a Stormy Sea"/>
